...
#> ℹ [2026-07-19 06:45:42] [INFO] Simulated 20.0 s @ 1000 Hz (20000 samples, 5.72%
...
out <- sim |>
  ...
  eyeris::lpfilt() |>
  eyeris::zscore()
#> ! [2026-07-19 06:45:42] [WARN] Left 995 sample(s) as NA across gaps longer than
#> 250 ms (not interpolated).
#> ! [2026-07-19 06:45:42] [WARN] `lpfilt()` is operating on data that contains
...
plot(out, seed = 1)
#> ℹ [2026-07-19 06:45:42] [INFO] Plotting block 1 with sampling rate 1000 Hz from
#> possible blocks: 1
dev.off()
#> agg_record_1a353867686c 
#>                       2 
# }
```
