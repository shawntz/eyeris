...
<div style="display: flex; justify-content: center; gap: 20px;"><span><img src="inst/figures/ts_coalesced.gif" width="49%" alt="glassbox timeseries animation"></span><span><img src="inst/figures/hists_coalesced.gif" width="49%" alt="glassbox histograms animation"></span></div>
...
```{r, eval=FALSE, echo=FALSE, fig.width=12, fig.height=9, fig.dpi=300}
