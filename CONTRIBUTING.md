...
Thank you for considering contributing to the `eyeris` R package. We
created this template to be community-driven, as we believe the best
preprocessing practices emerge from collective expertise and rigorous
discussion.
...
2.  **Fork & Create Branch**
    ...
    - Use clear branch names (e.g., `fix-some-issue`,
...
3.  **Documentation**
    - Update `README.Rmd` (only if needed; note: `README.md` is
      auto-generated from `README.Rmd`)
...
We appreciate your help in maintaining high-quality pupillometry
