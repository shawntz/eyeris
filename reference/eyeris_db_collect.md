...
#> ℹ [2026-07-16 23:55:52] [INFO] Epoching pupil data...
#> ℹ [2026-07-16 23:55:52] [INFO] Block 1: found 10 matching events for
#> PROBEstartstoptrial
#> ✔ [2026-07-16 23:55:52] [OKAY] Done!
#> ✔ [2026-07-16 23:55:52] [OKAY] Block 1: pupil data from 10 unique event
#> messages extracted
#> ✔ [2026-07-16 23:55:52] [OKAY] Pupil epoching completed in 0.13 seconds
#> ℹ [2026-07-16 23:55:52] [INFO] Recalculating epoched confounds for new
#> epochs...
#> ℹ [2026-07-16 23:55:52] [INFO] Starting BIDSify for sub-001 (monocular)
#> ℹ [2026-07-16 23:55:52] [INFO] Only 1 block detected...
#> ℹ [2026-07-16 23:55:52] [INFO] Using run_num = 03 for single block data
#> ℹ [2026-07-16 23:55:52] [INFO] Filtered epochs: epoch_prePostProbe
#> ℹ [2026-07-16 23:55:52] [INFO] Epoch names to save: epoch_prePostProbe
...
#> /tmp/RtmpDQ3i95/derivatives/my-project_temp_6979_20260716_235552_826.eyerisdb
#> ℹ [2026-07-16 23:55:52] [INFO] epoch_prePostProbe:
#> ℹ [2026-07-16 23:55:52] [INFO] block_3: data.frame with 20000 rows
#> ℹ [2026-07-16 23:55:52] [INFO] info: list with 1 elements
#> ! [2026-07-16 23:55:52] [WARN] '/tmp/RtmpDQ3i95' already exists. Skipping
#> creation...
#> ! [2026-07-16 23:55:52] [WARN] '/tmp/RtmpDQ3i95/derivatives' already exists.
#> Skipping creation...
#> ! [2026-07-16 23:55:52] [WARN] '/tmp/RtmpDQ3i95/derivatives/sub-001' already
#> exists. Skipping creation...
#> ! [2026-07-16 23:55:52] [WARN] '/tmp/RtmpDQ3i95/derivatives/sub-001/ses-01'
#> already exists. Skipping creation...
#> ! [2026-07-16 23:55:52] [WARN] '/tmp/RtmpDQ3i95/derivatives/sub-001/ses-01/eye'
#> already exists. Skipping creation...
...
#> ✔ [2026-07-16 23:55:52] [OKAY] Wrote blinks data (1 rows) to CSV and database
...
#> ✔ [2026-07-16 23:55:53] [OKAY] Wrote events data (67 rows) to CSV and database
#> ℹ [2026-07-16 23:55:53] [INFO] Processing single-run epoch: epoch_prePostProbe
#> (label: prePostProbe)
#> ℹ [2026-07-16 23:55:53] [INFO] Block block_3 for epoch epoch_prePostProbe has
#> 20000 rows
#> ! [2026-07-16 23:55:53] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ℹ [2026-07-16 23:55:53] [INFO] Found epoch events in structure:
...
#> ! [2026-07-16 23:55:53] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ✔ [2026-07-16 23:55:53] [OKAY] Wrote epochs data (20000 rows) to CSV and
#> database
#> ✔ [2026-07-16 23:55:53] [OKAY] Wrote timeseries data (20767 rows) to CSV and
#> database
#> ✔ [2026-07-16 23:55:53] [OKAY] Wrote run_confounds data (6 rows) to CSV and
#> database
#> ! [2026-07-16 23:55:53] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ℹ [2026-07-16 23:55:53] [INFO] Created epoch summary for epoch_prePostProbe
#> with 9 fields
#> ✔ [2026-07-16 23:55:53] [OKAY] Wrote epoch_summary data (1 rows) to CSV and
#> database
#> ! [2026-07-16 23:55:53] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ℹ [2026-07-16 23:55:53] [INFO] Found epoch events in structure:
...
#> ! [2026-07-16 23:55:53] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ✔ [2026-07-16 23:55:53] [OKAY] Wrote confounds_summary data (1 rows) to CSV and
#> database
#> ✔ [2026-07-16 23:55:53] [OKAY] Wrote confounds_summary data (1 rows) to CSV and
#> database
#> ✔ [2026-07-16 23:55:53] [OKAY] Wrote confounds_summary data (1 rows) to CSV and
...
#> ! [2026-07-16 23:55:53] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ℹ [2026-07-16 23:55:53] [INFO] Found epoch events in epoch structure:
#> PROBE_{startstop}_{trial}
#> ! [2026-07-16 23:55:53] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ! [2026-07-16 23:55:53] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ✔ [2026-07-16 23:55:54] [OKAY] Wrote confounds_events data (6 rows) to CSV and
#> database
#> ✔ [2026-07-16 23:55:54] [OKAY] Wrote confounds_events data (6 rows) to CSV and
#> database
#> ✔ [2026-07-16 23:55:54] [OKAY] Wrote confounds_events data (6 rows) to CSV and
...
#> already exists. Skipping creation...
#> ℹ [2026-07-16 23:55:54] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:55:54] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:55:55] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:55:56] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:55:57] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:55:57] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:55:58] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:55:58] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:55:59] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:56:00] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:56:00] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:56:01] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:56:01] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:56:02] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:56:02] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-16 23:56:02] [INFO] Plotting block 3 with sampling rate 1000 Hz from
...
#> ℹ [2026-07-16 23:56:02] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ! [2026-07-16 23:56:03] [WARN]
#> '/tmp/RtmpDQ3i95/derivatives/sub-001/ses-01/source/figures/task-assocret_run-03'
#> already exists. Skipping creation...
#> ✔ [2026-07-16 23:56:03] [OKAY] Created gaze heatmap for run-03
#> ! [2026-07-16 23:56:03] [WARN]
#> '/tmp/RtmpDQ3i95/derivatives/sub-001/ses-01/source/figures/task-assocret_run-03'
#> already exists. Skipping creation...
#> ℹ [2026-07-16 23:56:03] [INFO]
#> '/tmp/RtmpDQ3i95/derivatives/sub-001/ses-01/source/figures/task-assocret_run-03/epoch_prePostProbe'
#> does not exist. Creating...
#> ✔ [2026-07-16 23:56:03] [OKAY] BIDS directory successfully created at:
#> '/tmp/RtmpDQ3i95/derivatives/sub-001/ses-01/source/figures/task-assocret_run-03/epoch_prePostProbe'
#> ✔ [2026-07-16 23:56:20] [OKAY] Created epoch images zip:
...
#> (70 images)
#> ℹ [2026-07-16 23:56:20] [INFO] Using absolute zip file path:
#> /tmp/RtmpDQ3i95/derivatives/sub-001/ses-01/source/figures/task-assocret_run-03/epoch_prePostProbe/task-assocret_run-03.zip
#> ✔ [2026-07-16 23:56:20] [OKAY] Embedded zip file as data URL (11755799 bytes)
#> 
#> 
...
#> ℹ [2026-07-16 23:56:32] [INFO] Created new table 'events_001_01_assocret_run03'
#> with 67 rows
#> ℹ [2026-07-16 23:56:32] [INFO] Created new table
#> 'run_confounds_001_01_assocret_run03' with 6 rows
#> ℹ [2026-07-16 23:56:32] [INFO] Created new table
#> 'timeseries_001_01_assocret_run03' with 20767 rows
#> ✔ [2026-07-16 23:56:32] [OKAY] Successfully merged 8/8 tables
#> ✔ [2026-07-16 23:56:32] [OKAY] Successfully merged job unknown (PID: 6979) data
#> into main database
#> ℹ [2026-07-16 23:56:32] [INFO] Disconnected from temporary database
#> ✔ [2026-07-16 23:56:32] [OKAY] Cleaned up temporary database file
#> ℹ [2026-07-16 23:56:32] [INFO] Finished BIDSify for sub-001 (Duration: 40.14
#> seconds)

# extract all data for all subjects (returns list of data frames)
all_data <- eyeris_db_collect(tempdir())
#> ℹ [2026-07-16 23:56:32] [INFO] Connecting to eyeris database...
#> ✔ [2026-07-16 23:56:32] [OKAY] Connected to eyeris database:
#> /tmp/RtmpDQ3i95/derivatives/my-project.eyerisdb
#> ℹ [2026-07-16 23:56:33] [INFO] Found 16 tables in database
#> ℹ [2026-07-16 23:56:33] [INFO] Extracting data types: blinks, events,
#> timeseries, epochs, epoch_summary, run_confounds, confounds_events,
#> confounds_summary
#> ℹ [2026-07-16 23:56:33] [INFO] Processing blinks...
#> ℹ [2026-07-16 23:56:33] [INFO] Executing query: SELECT * FROM (SELECT
...
#> WHERE 1=1
#> ℹ [2026-07-16 23:56:33] [INFO] Processing events...
#> ℹ [2026-07-16 23:56:33] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> WHERE 1=1
#> ℹ [2026-07-16 23:56:33] [INFO] Processing timeseries...
#> ℹ [2026-07-16 23:56:33] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> ℹ [2026-07-16 23:56:33] [INFO] Processing epochs...
#> ℹ [2026-07-16 23:56:33] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> ℹ [2026-07-16 23:56:33] [INFO] Processing epoch_summary...
#> ℹ [2026-07-16 23:56:33] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> ℹ [2026-07-16 23:56:33] [INFO] Processing run_confounds...
#> ℹ [2026-07-16 23:56:33] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> WHERE 1=1
#> ℹ [2026-07-16 23:56:33] [INFO] Processing confounds_events...
#> ℹ [2026-07-16 23:56:33] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> 1=1
#> ℹ [2026-07-16 23:56:33] [INFO] Processing confounds_summary...
#> ℹ [2026-07-16 23:56:33] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> 1=1
#> ✔ [2026-07-16 23:56:33] [OKAY] Successfully extracted 8 data types
#> ℹ [2026-07-16 23:56:33] [INFO] blinks: 3 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] events: 201 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] timeseries: 62301 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] epochs: 40000 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] epoch_summary: 2 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] run_confounds: 18 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] confounds_events: 120 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] confounds_summary: 20 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] Disconnected from eyeris database
...
#> ℹ [2026-07-16 23:56:33] [INFO] Connecting to eyeris database...
#> ✔ [2026-07-16 23:56:33] [OKAY] Connected to eyeris database:
#> /tmp/RtmpDQ3i95/derivatives/my-project.eyerisdb
#> ℹ [2026-07-16 23:56:33] [INFO] Found 16 tables in database
#> ℹ [2026-07-16 23:56:33] [INFO] Extracting data types: blinks, epochs,
#> timeseries
#> ℹ [2026-07-16 23:56:33] [INFO] Processing blinks...
#> ℹ [2026-07-16 23:56:33] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> '001'
#> ✔ [2026-07-16 23:56:33] [OKAY] Successfully extracted 3 data types
#> ℹ [2026-07-16 23:56:33] [INFO] blinks: 3 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] epochs: 40000 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] timeseries: 62301 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] Disconnected from eyeris database
...
#> /tmp/RtmpDQ3i95/derivatives/my-project.eyerisdb
#> ℹ [2026-07-16 23:56:33] [INFO] Found 16 tables in database
#> ℹ [2026-07-16 23:56:33] [INFO] Extracting data types: epochs
#> ℹ [2026-07-16 23:56:33] [INFO] Processing epochs...
#> ℹ [2026-07-16 23:56:33] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
#> "epoch_label", "created_timestamp", "block", "time_orig", "timebin",
...
#> "template", "matching_pattern", "matched_event", "startstop", "trial" FROM
#> "epochs_001_01_assocret_run03_prepostprobe") as combined_data WHERE 1=1
#> ✔ [2026-07-16 23:56:33] [OKAY] Successfully extracted 1 data types
#> ℹ [2026-07-16 23:56:33] [INFO] epochs: 40000 rows across 1 subjects
#> ℹ [2026-07-16 23:56:33] [INFO] Disconnected from eyeris database
