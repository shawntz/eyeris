...
```{r echo=FALSE}
knitr::include_graphics("inst/figures/eyeris_glassbox_ts_demo.gif")
knitr::include_graphics("inst/figures/eyeris_glassbox_hists_demo.gif")
```
...
```{r, echo=FALSE, fig.width=12, fig.height=9, fig.dpi=300}
