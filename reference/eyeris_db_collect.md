...
#> ✔ [2026-07-03 02:13:38] [OKAY] Running eyeris::load_asc()
...
#> ℹ [2026-07-03 02:13:39] [INFO] Epoching pupil data...
#> ℹ [2026-07-03 02:13:39] [INFO] Block 1: found 10 matching events for
#> PROBEstartstoptrial
#> ✔ [2026-07-03 02:13:39] [OKAY] Done!
#> ✔ [2026-07-03 02:13:39] [OKAY] Block 1: pupil data from 10 unique event
#> messages extracted
#> ✔ [2026-07-03 02:13:39] [OKAY] Pupil epoching completed in 0.11 seconds
#> ℹ [2026-07-03 02:13:39] [INFO] Recalculating epoched confounds for new
#> epochs...
#> ℹ [2026-07-03 02:13:39] [INFO] Starting BIDSify for sub-001 (monocular)
#> ℹ [2026-07-03 02:13:39] [INFO] Only 1 block detected...
#> ℹ [2026-07-03 02:13:39] [INFO] Using run_num = 03 for single block data
#> ℹ [2026-07-03 02:13:39] [INFO] Filtered epochs: epoch_prePostProbe
#> ℹ [2026-07-03 02:13:39] [INFO] Epoch names to save: epoch_prePostProbe
#> ℹ [2026-07-03 02:13:39] [INFO] Parallel processing detected for job unknown
#> (PID: 6697), using temporary database
#> ✔ [2026-07-03 02:13:39] [OKAY] Created temporary database:
#> /tmp/RtmphK0wu2/derivatives/my-project_temp_6697_20260703_021339_338.eyerisdb
#> ℹ [2026-07-03 02:13:39] [INFO] epoch_prePostProbe:
#> ℹ [2026-07-03 02:13:39] [INFO] block_1: data.frame with 20000 rows
#> ℹ [2026-07-03 02:13:39] [INFO] info: list with 1 elements
#> ! [2026-07-03 02:13:39] [WARN] '/tmp/RtmphK0wu2' already exists. Skipping
#> creation...
#> ! [2026-07-03 02:13:39] [WARN] '/tmp/RtmphK0wu2/derivatives' already exists.
#> Skipping creation...
#> ! [2026-07-03 02:13:39] [WARN] '/tmp/RtmphK0wu2/derivatives/sub-001' already
#> exists. Skipping creation...
#> ! [2026-07-03 02:13:39] [WARN] '/tmp/RtmphK0wu2/derivatives/sub-001/ses-01'
#> already exists. Skipping creation...
#> ! [2026-07-03 02:13:39] [WARN] '/tmp/RtmphK0wu2/derivatives/sub-001/ses-01/eye'
#> already exists. Skipping creation...
#> ℹ [2026-07-03 02:13:39] [INFO] Writing blinks data to
#> /tmp/RtmphK0wu2/derivatives/sub-001/ses-01/eye/sub-001_ses-01_task-assocret_run-03_desc-blinks.csv...
#> ✔ [2026-07-03 02:13:39] [OKAY] Wrote blinks data (1 rows) to CSV and database
#> ℹ [2026-07-03 02:13:39] [INFO] Writing events data to
#> /tmp/RtmphK0wu2/derivatives/sub-001/ses-01/eye/sub-001_ses-01_task-assocret_run-03_desc-events.csv...
#> ✔ [2026-07-03 02:13:39] [OKAY] Wrote events data (67 rows) to CSV and database
#> ℹ [2026-07-03 02:13:39] [INFO] Processing single-run epoch: epoch_prePostProbe
#> (label: prePostProbe)
#> ℹ [2026-07-03 02:13:39] [INFO] Block block_1 for epoch epoch_prePostProbe has
#> 20000 rows
#> ! [2026-07-03 02:13:39] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ! [2026-07-03 02:13:39] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ! [2026-07-03 02:13:39] [WARN] No baseline structure found for epoch label:
...
#> ! [2026-07-03 02:13:39] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ✔ [2026-07-03 02:13:39] [OKAY] Wrote epochs data (20000 rows) to CSV and
#> database
#> ✔ [2026-07-03 02:13:40] [OKAY] Wrote timeseries data (20767 rows) to CSV and
#> database
#> ✔ [2026-07-03 02:13:40] [OKAY] Wrote run_confounds data (6 rows) to CSV and
#> database
#> ! [2026-07-03 02:13:40] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ℹ [2026-07-03 02:13:40] [INFO] Created epoch summary for epoch_prePostProbe
#> with 9 fields
#> ✔ [2026-07-03 02:13:40] [OKAY] Wrote epoch_summary data (1 rows) to CSV and
#> database
#> ! [2026-07-03 02:13:40] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ℹ [2026-07-03 02:13:40] [INFO] Found epoch events in structure:
#> PROBE_{startstop}_{trial}
#> ! [2026-07-03 02:13:40] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ! [2026-07-03 02:13:40] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ✔ [2026-07-03 02:13:40] [OKAY] Wrote confounds_summary data (1 rows) to CSV and
#> database
#> ✔ [2026-07-03 02:13:40] [OKAY] Wrote confounds_summary data (1 rows) to CSV and
#> database
#> ✔ [2026-07-03 02:13:40] [OKAY] Wrote confounds_summary data (1 rows) to CSV and
...
#> ! [2026-07-03 02:13:40] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ℹ [2026-07-03 02:13:40] [INFO] Found epoch events in epoch structure:
#> PROBE_{startstop}_{trial}
#> ! [2026-07-03 02:13:40] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ! [2026-07-03 02:13:40] [WARN] No baseline structure found for epoch label:
#> prePostProbe
#> ✔ [2026-07-03 02:13:40] [OKAY] Wrote confounds_events data (6 rows) to CSV and
#> database
#> ✔ [2026-07-03 02:13:40] [OKAY] Wrote confounds_events data (6 rows) to CSV and
#> database
#> ✔ [2026-07-03 02:13:40] [OKAY] Wrote confounds_events data (6 rows) to CSV and
...
#> already exists. Skipping creation...
#> ℹ [2026-07-03 02:13:40] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-03 02:13:40] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-03 02:13:40] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-03 02:13:41] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-03 02:13:41] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-03 02:13:41] [INFO] Plotting block 3 with sampling rate 1000 Hz from
...
#> ℹ [2026-07-03 02:13:41] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-03 02:13:42] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-03 02:13:42] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ℹ [2026-07-03 02:13:42] [INFO] Plotting block 3 with sampling rate 1000 Hz from
...
#> ℹ [2026-07-03 02:13:42] [INFO] Plotting block 3 with sampling rate 1000 Hz from
#> possible blocks: 3
#> ! [2026-07-03 02:13:42] [WARN]
#> '/tmp/RtmphK0wu2/derivatives/sub-001/ses-01/source/figures/task-assocret_run-03'
#> already exists. Skipping creation...
#> ✔ [2026-07-03 02:13:42] [OKAY] Created gaze heatmap for run-03
#> ! [2026-07-03 02:13:42] [WARN]
#> '/tmp/RtmphK0wu2/derivatives/sub-001/ses-01/source/figures/task-assocret_run-03'
#> already exists. Skipping creation...
#> ℹ [2026-07-03 02:13:42] [INFO]
#> '/tmp/RtmphK0wu2/derivatives/sub-001/ses-01/source/figures/task-assocret_run-03/epoch_prePostProbe'
#> does not exist. Creating...
#> ✔ [2026-07-03 02:13:42] [OKAY] BIDS directory successfully created at:
#> '/tmp/RtmphK0wu2/derivatives/sub-001/ses-01/source/figures/task-assocret_run-03/epoch_prePostProbe'
#> ✔ [2026-07-03 02:13:50] [OKAY] Created epoch images zip:
...
#> (70 images)
#> ℹ [2026-07-03 02:13:50] [INFO] Using absolute zip file path:
#> /tmp/RtmphK0wu2/derivatives/sub-001/ses-01/source/figures/task-assocret_run-03/epoch_prePostProbe/task-assocret_run-03.zip
#> ✔ [2026-07-03 02:13:50] [OKAY] Embedded zip file as data URL (7969936 bytes)
#> 
#> 
...
#> ℹ [2026-07-03 02:13:59] [INFO] Merged 20000 rows into existing table
#> 'epochs_001_01_assocret_run01_prepostprobe'
#> ℹ [2026-07-03 02:14:00] [INFO] Created new table 'events_001_01_assocret_run03'
#> with 67 rows
#> ℹ [2026-07-03 02:14:00] [INFO] Created new table
#> 'run_confounds_001_01_assocret_run03' with 6 rows
#> ℹ [2026-07-03 02:14:00] [INFO] Created new table
#> 'timeseries_001_01_assocret_run03' with 20767 rows
#> ✔ [2026-07-03 02:14:00] [OKAY] Successfully merged 8/8 tables
#> ✔ [2026-07-03 02:14:00] [OKAY] Successfully merged job unknown (PID: 6697) data
#> into main database
#> ℹ [2026-07-03 02:14:00] [INFO] Disconnected from temporary database
#> ✔ [2026-07-03 02:14:00] [OKAY] Cleaned up temporary database file
#> ℹ [2026-07-03 02:14:00] [INFO] Finished BIDSify for sub-001 (Duration: 21.14
#> seconds)

# extract all data for all subjects (returns list of data frames)
all_data <- eyeris_db_collect(tempdir())
#> ℹ [2026-07-03 02:14:00] [INFO] Connecting to eyeris database...
#> ✔ [2026-07-03 02:14:00] [OKAY] Connected to eyeris database:
#> /tmp/RtmphK0wu2/derivatives/my-project.eyerisdb
#> ℹ [2026-07-03 02:14:00] [INFO] Found 15 tables in database
#> ℹ [2026-07-03 02:14:00] [INFO] Extracting data types: blinks, events,
#> timeseries, epochs, epoch_summary, run_confounds, confounds_events,
#> confounds_summary
#> ℹ [2026-07-03 02:14:00] [INFO] Processing blinks...
#> ℹ [2026-07-03 02:14:00] [INFO] Executing query: SELECT * FROM (SELECT
...
#> WHERE 1=1
#> ℹ [2026-07-03 02:14:00] [INFO] Processing events...
#> ℹ [2026-07-03 02:14:00] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> WHERE 1=1
#> ℹ [2026-07-03 02:14:00] [INFO] Processing timeseries...
#> ℹ [2026-07-03 02:14:00] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> ℹ [2026-07-03 02:14:00] [INFO] Processing epochs...
#> ℹ [2026-07-03 02:14:00] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> ℹ [2026-07-03 02:14:00] [INFO] Processing epoch_summary...
#> ℹ [2026-07-03 02:14:00] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> ℹ [2026-07-03 02:14:00] [INFO] Processing run_confounds...
#> ℹ [2026-07-03 02:14:00] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> WHERE 1=1
#> ℹ [2026-07-03 02:14:00] [INFO] Processing confounds_events...
#> ℹ [2026-07-03 02:14:00] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> 1=1
#> ℹ [2026-07-03 02:14:00] [INFO] Processing confounds_summary...
#> ℹ [2026-07-03 02:14:00] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> 1=1
#> ✔ [2026-07-03 02:14:00] [OKAY] Successfully extracted 8 data types
#> ℹ [2026-07-03 02:14:00] [INFO] blinks: 3 rows across 1 subjects
#> ℹ [2026-07-03 02:14:00] [INFO] events: 201 rows across 1 subjects
#> ℹ [2026-07-03 02:14:00] [INFO] timeseries: 62301 rows across 1 subjects
#> ℹ [2026-07-03 02:14:00] [INFO] epochs: 40000 rows across 1 subjects
#> ℹ [2026-07-03 02:14:00] [INFO] epoch_summary: 2 rows across 1 subjects
#> ℹ [2026-07-03 02:14:00] [INFO] run_confounds: 18 rows across 1 subjects
#> ℹ [2026-07-03 02:14:00] [INFO] confounds_events: 120 rows across 1 subjects
#> ℹ [2026-07-03 02:14:00] [INFO] confounds_summary: 20 rows across 1 subjects
#> ℹ [2026-07-03 02:14:00] [INFO] Disconnected from eyeris database
...
#> /tmp/RtmphK0wu2/derivatives/my-project.eyerisdb
#> ℹ [2026-07-03 02:14:00] [INFO] Found 15 tables in database
#> ℹ [2026-07-03 02:14:00] [INFO] Extracting data types: blinks, epochs,
#> timeseries
#> ℹ [2026-07-03 02:14:00] [INFO] Processing blinks...
#> ℹ [2026-07-03 02:14:00] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
...
#> '001'
#> ✔ [2026-07-03 02:14:01] [OKAY] Successfully extracted 3 data types
#> ℹ [2026-07-03 02:14:01] [INFO] blinks: 3 rows across 1 subjects
#> ℹ [2026-07-03 02:14:01] [INFO] epochs: 40000 rows across 1 subjects
#> ℹ [2026-07-03 02:14:01] [INFO] timeseries: 62301 rows across 1 subjects
#> ℹ [2026-07-03 02:14:01] [INFO] Disconnected from eyeris database
...
#> ℹ [2026-07-03 02:14:01] [INFO] Connecting to eyeris database...
#> ✔ [2026-07-03 02:14:01] [OKAY] Connected to eyeris database:
#> /tmp/RtmphK0wu2/derivatives/my-project.eyerisdb
#> ℹ [2026-07-03 02:14:01] [INFO] Found 15 tables in database
#> ℹ [2026-07-03 02:14:01] [INFO] Extracting data types: epochs
#> ℹ [2026-07-03 02:14:01] [INFO] Processing epochs...
#> ℹ [2026-07-03 02:14:01] [INFO] Executing query: SELECT * FROM (SELECT
#> "subject_id", "session_id", "task_name", "data_type", "run_number",
#> "epoch_label", "created_timestamp", "block", "time_orig", "timebin",
#> "time_secs", "time_scaled", "eye_x", "eye_y", "eye", "hz", "type", "pupil_raw",
#> "pupil_raw_deblink", "pupil_raw_deblink_detransient",
...
#> "template", "matching_pattern", "matched_event", "startstop", "trial" FROM
#> "epochs_001_01_assocret_run01_prepostprobe") as combined_data WHERE 1=1
#> ✔ [2026-07-03 02:14:01] [OKAY] Successfully extracted 1 data types
#> ℹ [2026-07-03 02:14:01] [INFO] epochs: 40000 rows across 1 subjects
#> ℹ [2026-07-03 02:14:01] [INFO] Disconnected from eyeris database
