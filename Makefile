...
getdeps:
	...
	Rscript -e "deps <- c('eyelinker', 'dplyr', 'gsignal', 'tidyr', 'zoo', 'purrr', 'cli', 'rlang', 'stringr', 'utils', 'stats', 'graphics', 'grDevices', 'progress', 'data.table', 'withr', 'lifecycle', 'MASS', 'viridis', 'fields', 'jsonlite', 'rmarkdown', 'duckdb', 'DBI', 'glue'); install.packages(deps, repos = 'http://cran.us.r-project.org')" > /dev/null
