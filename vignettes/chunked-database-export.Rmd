...
- Save files to `bids_dir/derivatives/chunked_export/my-proj/`
...
```
derivatives/chunked_export/my-proj/
...
files <- list.files(
  "path/to/chunked_export/my-project/", 
...
combined_data <- read_eyeris_parquet(
  parquet_dir = "path/to/chunked_export/my-project/",
