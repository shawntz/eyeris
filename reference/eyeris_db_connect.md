...
#> ✔ [2026-06-05 14:59:47] [OKAY] Connected to eyeris database:
#> /tmp/RtmpokLa2t/derivatives/my-project.eyerisdb
#> ℹ [2026-06-05 14:59:47] [INFO] Executing query: SELECT * FROM (SELECT * FROM
...
#> '001'
#> ℹ [2026-06-05 14:59:47] [INFO] Disconnected from eyeris database
# }
```
