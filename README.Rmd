...
| **Database Storage**       | [eyeris_extract_data()](https://shawnschwartz.com/eyeris/reference/eyeris_extract_data.html)            | High-performance database storage and querying alternative to CSV files.                                   |
...
- [🗄️ Database Storage Guide: Scalable Alternative to CSV Files](https://shawnschwartz.com/eyeris/articles/database-guide.html)
...
## 🗄️ Database Storage: Scalable Alternative to CSV Files
...
**☁️ Cloud Computing Optimized**
- Dramatically reduce I/O costs on AWS, GCP, Azure
...
**🔒 Data Integrity**
- ACID compliance ensures data integrity during concurrent access
...
all_data <- eyeris_extract_data("~/my_study", "study_database")
...
For large studies (>50 subjects), databases provide significant advantages:
...
> **💡 Tip**: Use `csv_enabled = FALSE, db_enabled = TRUE` for cloud computing to maximize efficiency and minimize costs.
