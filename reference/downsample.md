...
so the anti-aliasing filter can run and then masked back to `NA`. This
can slightly bias the valid samples immediately adjacent to each gap
toward the interpolated values, so a warning is emitted in this case. If
that bias is a concern, consider disabling this step
...
demo_data |>
  ...
  plot(seed = 0)
#> ✔ [2026-07-18 23:35:19] [OKAY] Running eyeris::load_asc()
#> ✔ [2026-07-18 23:35:19] [OKAY] Running eyeris::resample()
#> ℹ [2026-07-18 23:35:19] [INFO] Processing block: block_1
#> ✔ [2026-07-18 23:35:19] [OKAY] Running eyeris::deblink() for block_1
#> ✔ [2026-07-18 23:35:19] [OKAY] Running eyeris::detransient() for block_1
#> ✔ [2026-07-18 23:35:19] [OKAY] Running eyeris::interpolate() for block_1
#> ! [2026-07-18 23:35:19] [WARN] Interpolation now leaves gaps longer than 250 ms
...
#> `interpolate()`).
#> ✔ [2026-07-18 23:35:19] [OKAY] Running eyeris::lpfilt() for block_1

#> ✔ [2026-07-18 23:35:19] [OKAY] Running eyeris::downsample() for block_1

#> ✔ [2026-07-18 23:35:20] [OKAY] Decimating sampling rate from 1000 Hz --> 100
#> Hz...
#> ! [2026-07-18 23:35:20] [WARN] Skipping eyeris::bin() for block_1
#> ! [2026-07-18 23:35:20] [WARN] Skipping eyeris::detrend() for block_1
#> ✔ [2026-07-18 23:35:20] [OKAY] Running eyeris::zscore() for block_1
#> ℹ [2026-07-18 23:35:20] [INFO] Block processing summary:
#> ℹ [2026-07-18 23:35:20] [INFO] block_1: OK (steps: 7, latest:
#> pupil_raw_deblink_detransient_interpolate_lpfilt_downsample_z)
#> ✔ [2026-07-18 23:35:20] [OKAY] Running eyeris::summarize_confounds()
#> ℹ [2026-07-18 23:35:20] [INFO] Plotting block 1 with sampling rate 100 Hz from
#> possible blocks: 1
