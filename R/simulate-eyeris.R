...
#'   and [eyeris::sim_pitfall()] for the educational before/after showcases.
#'
#' @examples
#' # default parameters
#' p <- sim_params()
...
#'
#' @seealso [eyeris::sim_params()] to configure the signal;
#'   [eyeris::sim_pitfall()] and [eyeris::sim_step_showcase()] for educational
#'   before/after demonstrations built on top of this generator.
#'
#' @examples
