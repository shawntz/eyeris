...
#> ✔ [2026-07-17 00:01:44] [OKAY] Running eyeris::load_asc()
#> ℹ [2026-07-17 00:01:45] [INFO] Processing block: block_1
#> ✔ [2026-07-17 00:01:45] [OKAY] Running eyeris::deblink() for block_1
#> ✔ [2026-07-17 00:01:45] [OKAY] Running eyeris::detransient() for block_1
#> ✔ [2026-07-17 00:01:45] [OKAY] Running eyeris::interpolate() for block_1
#> ✔ [2026-07-17 00:01:45] [OKAY] Running eyeris::lpfilt() for block_1
```

![](complete-pipeline_files/figure-html/unnamed-chunk-3-1.png)

    #> ! [2026-07-17 00:01:45] [WARN] Skipping eyeris::downsample() for block_1
    #> ! [2026-07-17 00:01:45] [WARN] Skipping eyeris::bin() for block_1
    #> ! [2026-07-17 00:01:45] [WARN] Skipping eyeris::detrend() for block_1
    #> ✔ [2026-07-17 00:01:45] [OKAY] Running eyeris::zscore() for block_1
    #> ℹ [2026-07-17 00:01:45] [INFO] Block processing summary:
    #> ℹ [2026-07-17 00:01:45] [INFO] block_1: OK (steps: 6, latest:
    #> pupil_raw_deblink_detransient_interpolate_lpfilt_z)
    #> ✔ [2026-07-17 00:01:45] [OKAY] Running eyeris::summarize_confounds()
    ...
    #> ℹ [2026-07-17 00:01:45] [INFO] Plotting block 1 with sampling rate 1000 Hz from
    #> possible blocks: 1
...
#> ✔ [2026-07-17 00:01:50] [OKAY] Running eyeris::load_asc()
#> ℹ [2026-07-17 00:01:50] [INFO] Processing block: block_1
#> ✔ [2026-07-17 00:01:50] [OKAY] Running eyeris::deblink() for block_1
#> ✔ [2026-07-17 00:01:50] [OKAY] Running eyeris::detransient() for block_1
#> ✔ [2026-07-17 00:01:50] [OKAY] Running eyeris::interpolate() for block_1
#> ✔ [2026-07-17 00:01:50] [OKAY] Running eyeris::lpfilt() for block_1
#> ! [2026-07-17 00:01:50] [WARN] Skipping eyeris::downsample() for block_1
#> ! [2026-07-17 00:01:50] [WARN] Skipping eyeris::bin() for block_1
#> ! [2026-07-17 00:01:50] [WARN] Skipping eyeris::detrend() for block_1
#> ✔ [2026-07-17 00:01:50] [OKAY] Running eyeris::zscore() for block_1
#> ℹ [2026-07-17 00:01:50] [INFO] Block processing summary:
#> ℹ [2026-07-17 00:01:50] [INFO] block_1: OK (steps: 6, latest:
#> pupil_raw_deblink_detransient_interpolate_lpfilt_z)
#> ✔ [2026-07-17 00:01:50] [OKAY] Running eyeris::summarize_confounds()
```
